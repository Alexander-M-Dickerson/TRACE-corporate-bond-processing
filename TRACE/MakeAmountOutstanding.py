...
# Part (vi): Monthly Amount Outstanding  #
# Alexander Dickerson                    #
...
Overview
-------------
This Python script downloads the bond amount outstanding and action-change data
i.e., the variables we need to compute how much of the bond issue remains.

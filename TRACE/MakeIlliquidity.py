...
# Part (iv): Monthly Bao et al. (2011)   #
# Illiquidity (ILLIQ)                    #
...
Overview
-------------
This Python script computes monthly bond illiquidity (ILLIQ) following 
Bao et al. (2011) Equation (2) from the Journal of Finance paper.

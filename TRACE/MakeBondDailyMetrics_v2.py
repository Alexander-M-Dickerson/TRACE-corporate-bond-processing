...
#* Merge                                  */
#* ************************************** */
traced = dfp.merge(dfv, how = "inner", left_on = ['trd_exctn_dt','cusip_id'],
...
fisd_kpp =  fisd[fisd['complete_cusip'].isin(IDs_KPP['complete_cusip'])]
fisd_kpp.rename(columns={'complete_cusip':'cusip'}, inplace=True)
...
fisd = pd.concat([fisd, fisd_kpp])
fisd = fisd.drop_duplicates(subset='cusip')
...
traced['maturity'] = pd.to_datetime(traced['maturity'])
